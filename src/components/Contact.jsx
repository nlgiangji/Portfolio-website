...
export default function Contact() {
  ...
  function handleForm(e) {
    ...
    axios
      .post("https://formsubmit.co/ajax/nlgiang2401@gmail.com", {
        name: name,
        message: message,
        email: email,
      })
  ...
  return (
    <>
      ...
      <section className="w-5/6 rounded-xl mx-auto bg-fit" style={{ backgroundImage: `url(${backgroundImg.src})` }}>
        <div className="sm:p-24 p-8 mx-auto mb-24">
          <div className="pb-8 text-center">
            <h1 className="text-primary sm:text-5xl text-3xl font-bold">Let's Work Together 🔥,</h1>
            <h1 className="text-primary sm:text-5xl text-3xl font-bold">Get in touch 👋</h1>
          </div>
          <form id="form" className="xl:px-24 sm:px-0" action="" onSubmit={handleForm}>
            ...
            <div className="text-center">
              <input onClick={Check} type="submit" value="submit" className="px-4 py-2 rounded-md bg-white font-bold" />
            </div>
          </form>
        </div>
      </section>
